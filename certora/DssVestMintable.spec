...
rule vest_revert(uint256 _id) {
    ...
    assert(revert10 => lastReverted, "True stopped did not revert");
    assert(revert11 => lastReverted, "Overflow usr balance did not revert");
    assert(revert12 => lastReverted, "Overflow totalSupply did not revert");
