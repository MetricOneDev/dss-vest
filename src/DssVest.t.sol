...
contract DssVestTest is DSTest {
    ...
    address constant GOV_TOKEN = 0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2;
    address constant CHAINLOG = 0xdA0Ab1e0017DEbCd72Be8599041a2aa3bA7e740F;
    address constant VAT = 0x35D1b3F3D7966A1DFe207aa4514C12a259A0492B;
    address constant STBL_JOIN = 0x9759A6Ac90977b93B58547b4A71c78317f391A28;
    address constant STBL = 0x6B175474E89094C44Da98b954EedeAC495271d0F;
    ...
    function setUp() public {
        ...
        vest = new DssVestMintable(GOV_TOKEN);
    ...
    function testSuckableVest() public {
        ...
        assertEq(Token(STBL).balanceOf(address(this)), 1 * days_vest);
        assertEq(VatLikeTest(VAT).sin(VOW), originalSin + 1 * days_vest * RAY);
        hevm.warp(block.timestamp + 9 days);
        suckableVest.vest(id);
        assertEq(Token(STBL).balanceOf(address(this)), 10 * days_vest);
        assertEq(VatLikeTest(VAT).sin(VOW), originalSin + 10 * days_vest * RAY);
        hevm.warp(block.timestamp + 365 days);
        suckableVest.vest(id);
        assertEq(Token(STBL).balanceOf(address(this)), 100 * days_vest);
    ...
    function testTransferrableVest() public {
        ...
        assertEq(Token(STBL).balanceOf(address(boss)), 10000 * WAD);
        ...
        hevm.warp(block.timestamp + 1 days);
        tVest.vest(id);
        assertEq(Token(STBL).balanceOf(address(usr)), 1 * days_vest);
        assertEq(Token(STBL).balanceOf(address(boss)), 10000 * WAD - 1 * days_vest);
        hevm.warp(block.timestamp + 9 days);
        tVest.vest(id);
        assertEq(Token(STBL).balanceOf(address(usr)), 10 * days_vest);
        assertEq(Token(STBL).balanceOf(address(boss)), 10000 * WAD - 10 * days_vest);
        hevm.warp(block.timestamp + 365 days);
        tVest.vest(id);
        assertEq(Token(STBL).balanceOf(address(usr)), 100 * days_vest);
        assertEq(Token(STBL).balanceOf(address(boss)), 10000 * WAD - 100 * days_vest);
        hevm.warp(block.timestamp + 365 days);
        tVest.vest(id);
        assertEq(Token(STBL).balanceOf(address(usr)), 100 * days_vest);
        assertEq(Token(STBL).balanceOf(address(boss)), 10000 * WAD - 100 * days_vest);
